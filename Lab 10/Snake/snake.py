...
def get_username():
    ...
    username = ""
    input_box = pygame.Rect(20, 60, 200, 32)
...
def run_game(username):
    ...
    class Wall:
      ...
      def load_wall(self):
        with open(r"C:\Users\hp\Desktop\PP2\Lab 10\Snake\level1.txt", 'r') as f:
    ...
    while running:
        ...
        wallsCoor = open(r"C:\Users\hp\Desktop\PP2\Lab 10\Snake\level2.txt", 'r').readlines()
        walls = []
...
def main():
    ...
    if result is None:
        ...
        insert(username)
        # You can choose to handle the warning condition differently,
        # such as asking the user to create a new user or terminating the program.
    else:
        exists, level = result
